...
ALLOWED_HOSTS = env.list('ALLOWED_HOSTS', default=['127.0.0.1', 'localhost','10.0.0.41'])
...
MIDDLEWARE = [
    ...
    'dashboard.middleware.ForcePasswordChangeMiddleware', # Nuestro guardián para forzar cambio de contraseña
